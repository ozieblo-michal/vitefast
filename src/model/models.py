...
class Dummy(Base):
    ...
    This model is used to store information about 'Dummy' objects, with attributes such as id,
    name, description, and an optional field.
    ...
    Attributes:
        ...
        description (str): A description of the Dummy object. It is a required field and cannot
                           be NULL.
...
class User(Base):
    ...
    This model is used for storing user information, including attributes like username, full name,
    email, password, and disabled status.
    ...
    Attributes:
        ...
        password (str): The encrypted password of the user. Ensure this is not exposed in API
                        responses.
